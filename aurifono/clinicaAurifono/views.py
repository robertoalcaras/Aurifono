...
from .forms import AtaqueVocalForm, ComunicOralForm, LoudnessForm, ModulacaoForm, PitchForm, QualidadeemissForm, RessonanciaForm, TipoVozForm, pacienteForm, profissionalForm
from .models import AtaqueVocal, Loudness, Modulacao, Pitch, Qualidadeemis, Ressonancia, comunicoral_comunicoral, paciente_paciente, profissionalenc_profissionalenc, TipoVoz
